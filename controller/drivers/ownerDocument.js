...
exports.ownerDocuments = async function(req, res) {
    ...
    try {
        ...
        fs.writeFileSync(data.pan_card, req.files.panCard.data, (err) => {
            if (err) { return console.error(err) }
        })

        if (req.files.passbook !== undefined) {
            fs.writeFileSync(data.passbook, req.files.passbook.data, (err) => {
                if (err) { return console.error(err) }
            })
        } else {
            data.passbook = null
        ...
        if (req.files.rentalAgreement1 !== undefined) {
            fs.writeFileSync(data.rental_agreement1, req.files.rentalAgreement1.data, (err) => {
                if (err) { return console.error(err) }
            })
        } else {
        ...
        if (req.files.rentalAgreement2 !== undefined) {
            fs.writeFileSync(data.rental_agreement2, req.files.rentalAgreement2.data, (err) => {
                if (err) { return console.error(err) }
            })
        } else {
        ...
        if (typeof req.files.aadharFront !== 'undefined') {
            ...
            await s3bucketBuffer(data.aadhar_front, req.body.driverId, '/aadharFront', '/owner', time, req.files.aadharFront.data).then((url) => {
                console.log(url)
        ...
        if (typeof req.files.aadharBack !== 'undefined') {
            ...
            // test
            // fs.chmodSync(selfie, 0o755)
            await s3bucketBuffer(data.aadhar_back, req.body.driverId, '/aadharBack', '/owner', time, req.files.aadharBack.data).then((url) => {
                console.log(url)
        ...
        if (typeof req.files.panCard !== 'undefined') {
            ...
            // test
            // fs.chmodSync(selfie, 0o755)
            await s3bucketBuffer(data.pan_card, req.body.driverId, '/panCard', '/owner', time, req.files.panCard.data).then((url) => {
                console.log(url)
        ...
        if (typeof req.files.passbook !== 'undefined') {
            ...
            // test
            // fs.chmodSync(selfie, 0o755)
            await s3bucketBuffer(data.passbook, req.body.driverId, '/passbook', '/owner', time, req.files.passbook.data).then((url) => {
                console.log(url)
        ...
        if (typeof req.files.rentalAgreement1 !== 'undefined') {
            ...
            // test
            // fs.chmodSync(selfie, 0o755)
            await s3bucketBuffer(data.rental_agreement1, req.body.driverId, '/rentalAgreement1', '/owner', time, req.files.rentalAgreement1.data).then((url) => {
                console.log(url)
        ...
        if (typeof req.files.rentalAgreement2 !== 'undefined') {
            ...
            // test
            // fs.chmodSync(selfie, 0o755)
            await s3bucketBuffer(data.rental_agreement2, req.body.driverId, '/rentalAgreement2', '/owner', time, req.files.rentalAgreement2.data).then((url) => {
                console.log(url)
